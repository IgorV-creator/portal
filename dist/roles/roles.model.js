...
const users_roles_1 = require("./users-roles");
...
__decorate([
    swagger_1.ApiProperty({ example: 'ADMIN', description: 'Роль Пользователя' }),
...
__decorate([
    swagger_1.ApiProperty({ example: 'Администратор', description: 'Описание роли' }),
    sequelize_typescript_2.Column({ type: sequelize_typescript_2.DataType.STRING, allowNull: false }),
    __metadata("design:type", String)
], Role.prototype, "description", void 0);
__decorate([
    sequelize_typescript_1.BelongsToMany(() => users_model_1.User, () => users_roles_1.UsersRoles),
