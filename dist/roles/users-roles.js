...
let UsersRoles = class UsersRoles extends sequelize_typescript_1.Model {
};
__decorate([
...
], UsersRoles.prototype, "id", void 0);
__decorate([
    ...
    __metadata("design:type", Number)
], UsersRoles.prototype, "roleId", void 0);
__decorate([
    sequelize_typescript_1.ForeignKey(() => users_model_1.User),
    sequelize_typescript_2.Column({ type: sequelize_typescript_2.DataType.INTEGER }),
    __metadata("design:type", Number)
], UsersRoles.prototype, "userId", void 0);
UsersRoles = __decorate([
